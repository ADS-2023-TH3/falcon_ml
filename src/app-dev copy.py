...
def main():
    ...
    if st.session_state.success:
        ...
        if len(st.session_state.recommendations) > 0:   # Display recommendations obtained from the form
            ...
            string_movies = ', '.join(selected_movies)
            string_rec = ', '.join(st.session_state.recommendations[0:5])
            add_log(st.session_state.username,selected_genre, string_movies,string_rec)
    ...
    for movie in movies:
        ...
        with col2:
            ...
            if rating > 0:
                ...
                #añadir a la hoja de excel
                add_rating(st.session_state.username, movie, rating)
